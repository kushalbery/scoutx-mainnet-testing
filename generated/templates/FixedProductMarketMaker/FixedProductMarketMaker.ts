...
export class FeesSet extends ethereum.Event {
  get params(): FeesSet__Params {
    return new FeesSet__Params(this);
  }
}

export class FeesSet__Params {
  _event: FeesSet;

  constructor(event: FeesSet) {
    this._event = event;
  }
