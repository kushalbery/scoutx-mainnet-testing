...
export class ConditionalTokens extends ethereum.SmartContract {
  ...
  checkAddress(msgsender: Address): boolean {
    let result = super.call("checkAddress", "checkAddress(address):(bool)", [
  ...
  try_checkAddress(msgsender: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("checkAddress", "checkAddress(address):(bool)", [
      ethereum.Value.fromAddress(msgsender)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class SetFpmmFactoryCall extends ethereum.Call {
  get inputs(): SetFpmmFactoryCall__Inputs {
    return new SetFpmmFactoryCall__Inputs(this);
  }

  get outputs(): SetFpmmFactoryCall__Outputs {
    return new SetFpmmFactoryCall__Outputs(this);
  }
}

export class SetFpmmFactoryCall__Inputs {
  _call: SetFpmmFactoryCall;

  constructor(call: SetFpmmFactoryCall) {
    this._call = call;
  }
...
export class SetFpmmFactoryCall__Outputs {
  _call: SetFpmmFactoryCall;
